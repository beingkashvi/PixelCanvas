...
//         <p className="mt-2 text-gray-400">Add some amazing custom products!</p>
//         <Link
//           href="/"
//           className="mt-8 inline-flex items-center rounded-md bg-blue-600 px-6 py-3 font-medium text-white hover:bg-blue-700"
//         >
//           Start Shopping
...
//                 {/* Product Image */}
//                 <div className="relative h-32 w-32 flex-shrink-0 overflow-hidden rounded-md bg-gray-700">
//                   <Image
...
//                         className="rounded-md border border-gray-600 bg-gray-700 p-2 text-white hover:bg-gray-600"
...
//           <div className="sticky top-24 rounded-lg border border-gray-700 bg-gray-800 p-6">
...
//             <Link
//               href="/"
//               className="mt-4 flex w-full items-center justify-center gap-2 rounded-md border border-gray-600 bg-gray-700 px-6 py-3 font-medium text-white hover:bg-gray-600"
//             >
//               Continue Shopping
//             </Link>
//           </div>
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-24 rounded-2xl bg-white/90 backdrop-blur-sm p-6 shadow-lg border border-purple-100">
            ...
            <button
              ...
              className="className=mt-6 w-full rounded-full bg-gradient-to-r from-purple-500 to-pink-500 px-6 py-4 font-bold text-white shadow-xl hover:shadow-2xl hover:scale-105 transition-all"
